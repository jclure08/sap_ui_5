...
sap.ui.define([
	...
	"sap/m/MessageBox"
], function (BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, core_formatter, MessageBox) {
	"use strict";

	return BaseController.extend("com.webstersys.surt.user.controller.Master", {
